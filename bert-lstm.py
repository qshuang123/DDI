...
logging.basicConfig(level=logging.INFO, filename='bert-lstm.log')
#????
maxlen=154
maxsdplen=28
max_features=20000
...
def buildmodel():
    ...
    z = Bidirectional(GRU(300, dropout=0.5, recurrent_dropout=0.5, return_sequences=False, activation='relu'))(
        bert_x)  # (?,?,600)
    ...
    RMS = keras.optimizers.RMSprop(lr=1e-3, rho=0.9, epsilon=None, decay=0.0)
